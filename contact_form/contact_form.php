...
// configure
$from = 'jesusmartheyn.github.io'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'jesusmartheyn@gmail.com'; // Replace it with Your email. REQUIRED!
$subject = 'New message from jesusmartheyn.com contact form';
